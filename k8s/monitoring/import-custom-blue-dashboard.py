#!/usr/bin/env python3
"""
Script để import dashboard custom với màu blue
"""
...
def import_dashboard():
    """Import dashboard custom với màu blue"""
    ...
    dashboard_path = Path(__file__).parent.parent.parent / "monitoring" / "grafana" / "dashboards" / "custom_blue_dashboard.json"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'url' in result:
                ...
                print(f"✅ Import dashboard custom thành công!")
...
def main():
    """Hàm chính"""
    print("🚀 Import Dashboard Custom - Màu Blue")
    print("=" * 50)
    
    # Import dashboard
    if import_dashboard():
        print("\n🎉 Import dashboard custom thành công!")
        print("🔗 Truy cập dashboard tại: http://localhost:3000")
        print("👤 Đăng nhập: admin / admin123")
        print("📊 Dashboard: Dashboard Custom - Màu Blue")
        print("🎨 Màu blue đã được áp dụng cho tỷ lệ lỗi!")
    else:
